document.querySelector(".drop-side").addEventListener("click", () => {
  document.getElementById("sidebar").classList.add("show-side");
});
document.querySelector(".btn-close-side").addEventListener("click", () => {
  document.getElementById("sidebar").className += "close-side";
});
